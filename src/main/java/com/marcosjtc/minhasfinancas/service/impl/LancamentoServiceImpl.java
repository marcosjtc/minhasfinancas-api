...
//Garante que está dentro do contêiner como injeção de serviço
@Service
public class LancamentoServiceImpl implements LancamentoService {
	
	private LancamentoRepository repository;
	
	//Construtor necessário para que haja a injeção.
	public LancamentoServiceImpl(LancamentoRepository repository) {
		//Injeção sem necessidade do @autowired por ser um bean gerenciável,
		//que possui a instância na classe.
	...
	public Lancamento atualizar(Lancamento lancamento) {
		// TODO Auto-generated method stub
		//Garantia de passar lancamento com id. Caso contrário null point exception
	...
	public List<Lancamento> buscar(Lancamento lancamentoFiltro) {
		...
		/*Sem usar o springdata seria assim
